...
public class ControleCliente {
	...
	public ResponseEntity<Cliente> obterCliente(@PathVariable Long id) {
		...
		if (cliente != null) {
			...
			return new ResponseEntity<Cliente>(cliente, HttpStatus.OK); // <-- Troque FOUND por OK
		} else {
	...
	public ResponseEntity<List<Cliente>> obterClientes() {
		...
		return new ResponseEntity<List<Cliente>>(clientes, HttpStatus.OK); // <-- Troque FOUND por OK
	}
